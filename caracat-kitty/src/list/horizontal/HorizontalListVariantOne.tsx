// HorizontalDoubleCardListWithMultipleMetaText;
...
export function HorizontalListVariantOne() {
  return (
...
HorizontalListVariantOne['Type'] = 'List';
HorizontalListVariantOne['UUID'] = 'List';

export default HorizontalListVariantOne;
