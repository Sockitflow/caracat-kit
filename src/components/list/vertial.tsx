...
export function VerticalItemListWithActionsAndDescriptions({
  images = IMAGES,
  items = ITEMS,
  leftIcon,
  rightIcon,
          ...
          <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
            ...
            >
              ...
              <View style={styles.pickerDates}>
                <Text style={styles.infoTitle}>{cardFooter.title}</Text>
              ...
              <View style={styles.pickerAction}>
                <Text style={styles.pickerActionText}>{cardFooter.action}</Text>
            ...
            <>
              <View style={styles.info}>
                <Text style={styles.infoTitle}>Tesla</Text>
